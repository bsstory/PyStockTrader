...
def SetUI(self):
    ...
    self.main_tabWidget.setTabIcon(4, icon_set)
    self.main_tabWidget.setTabIcon(5, icon_log)
    ...
    self.main_tabWidget.setTabToolTip(4, '  설정')
    self.main_tabWidget.setTabToolTip(5, '  로그')
    ...
    self.sj_stock_labellll_01 = QtWidgets.QLabel('리시버 및 콜렉터', self.sj_groupBox_05)
    ...
    self.sj_stock_labellll_04 = QtWidgets.QLabel('평균값계산틱수', self.sj_groupBox_05)
    self.sj_stock_lineEdit_04 = setLineedit(self.sj_groupBox_05)
    self.sj_stock_labellll_05 = QtWidgets.QLabel('최대매수종목수', self.sj_groupBox_05)
